...
return require('packer').startup(function(use)
  ...
  use {
    ...
    --   vim.keymap.set('v', '<leader>on', function() require('opencode').command('session_new') end,
    --     { desc = "New opencode session" })
    --   vim.keymap.set('v', '<leader>oy', function() require('opencode').command('messages_copy') end,
